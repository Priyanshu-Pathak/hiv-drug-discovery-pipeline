"""Stage 9: Run AutoDock Vina docking on prepared ligand PDBQT files.

Adapted from original notebook cell 041. Requires variables from Stage 8 if run interactively; for standalone use, run after Stage 8 in the same working directory or convert config paths as needed.
"""
