...
# NOTEBOOK SHELL: pip install openbabel-wheel
...
# NOTEBOOK SHELL: obabel -ipdb "{clean_pdb_renumbered}" -opdbqt -O "{receptor_pdbqt}" -xr -p 7.4 --partialcharge gasteiger
...
# NOTEBOOK SHELL: ls -lh "{receptor_pdbqt}"
# NOTEBOOK SHELL: grep -E "ROOT|BRANCH" "{receptor_pdbqt}" || echo "Verification OK: File is clean."
