"""Stage 2: Clean ChEMBL HIV-1 protease inhibitor records and convert SMILES to SELFIES.

Adapted from original notebook cells 007 and 009.
"""
# Notebook shell command removed for script execution: !pip -q install rdkit-pypi openpyxl
...
# Notebook shell command removed for script execution: !pip -q install selfies
