"""Stage 1: ZINC preprocessing, SELFIES tokenization, Transformer pretraining, and sample generation.

This script is adapted from code cell 002 of the original Kaggle notebook.
Install dependencies from environment.yml before running.
"""
# Notebook shell command removed for script execution: !pip -q install selfies rdkit-pypi openpyxl
